...
void print_population()
{
	...
	for(i=0;i<P;i++)
	{
		for(j=0;j<8;j++)
			cout << ' ' << population[i][j] << ' ';
		cout << "--> " << population_fitnessFunction[i]-OFFSET << "\n\n";
	}
}
