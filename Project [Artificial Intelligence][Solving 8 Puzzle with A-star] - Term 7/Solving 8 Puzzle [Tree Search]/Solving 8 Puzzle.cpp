...
int main()
{
    ...
    while(prg_continue=='y' || prg_continue=='Y')
    {
        ...
        frontier.add(init_Tiles,'I',0,NULL);
        cur_depth=-1;
        ...
        while(1)
        {
            ...
            if(up==true)
            {
                ...
                frontier.add(expand_Tiles,'U',L->depth+1,L);
            }
            if(down==true)
            {
                blankMove(L->tiles,BI,expand_Tiles,'D');
                frontier.add(expand_Tiles,'D',L->depth+1,L);
            }
            if(left==true)
            {
                blankMove(L->tiles,BI,expand_Tiles,'L');
                frontier.add(expand_Tiles,'L',L->depth+1,L);
            }
            if(right==true)
            {
                blankMove(L->tiles,BI,expand_Tiles,'R');
                frontier.add(expand_Tiles,'R',L->depth+1,L);
            }
        }
