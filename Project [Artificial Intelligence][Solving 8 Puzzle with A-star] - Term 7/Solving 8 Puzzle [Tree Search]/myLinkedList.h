...
class linkedList
{
    ...
    public:
        ...
        void add(short tiles[],char action,short depth,stateNode* parent);
...
void linkedList::add(short tiles[],char action,short depth,stateNode* parent)
{
    ...
    switch(heuristic_number)
    {
        case 0:
            ...
            break;
        case 1:
            new_f = depth + newNode->h1;
            break;
        case 2:
            new_f = depth + newNode->h2;
            break;
        default:
    ...
    while(current!=NULL)
    {
        switch(heuristic_number)
        {
            case 0:
                ...
                break;
            case 1:
                cur_f = current->depth + current->h1;
                break;
            case 2:
                cur_f = current->depth + current->h2;
                break;
            default:
